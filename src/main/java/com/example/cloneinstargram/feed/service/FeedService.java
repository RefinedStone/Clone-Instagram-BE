...
public class FeedService {
    ...
    public FeedUpdateDto updateFeed(String content, UserDetailsImpl userDetails, Long feedId) throws IOException {
        ...
        return new FeedUpdateDto ("Success updateFeed", HttpStatus.OK.value(), content);
    }
