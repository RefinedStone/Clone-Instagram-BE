package com.example.cloneinstargram.jwt.util;
...
import com.example.cloneinstargram.security.user.UserDetailsServiceImpl;
...
public class JwtUtil {
    ...
    private static final long ACCESS_TIME = 60 * 1000L * 100;
